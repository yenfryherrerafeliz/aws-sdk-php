...
class MultipartCopierTest extends TestCase
{
     ...
     * @return void
     */
    public function testConstructorThrowsOnInvalidSourceType(): void
    {
     ...
     * @return void
     */
    public function testConstructorThrowsOnMissingBucketKey(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        new MultipartCopier(
            $this->client,
     ...
     * @return void
     */
    public function testConstructorThrowsOnSameSourceAndDest(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        new MultipartCopier(
            $this->client,
     ...
     * @return void
     */
    public function testConstructorThrowsOnInvalidPartSizeConfig(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        new MultipartCopier(
            $this->client,
            ['Bucket' => 'dest', 'Key' => 'dest-key'],
            ['part_size' => 1 * 1024 * 1024, 'concurrency' => 1],
            ['Bucket' => 'src', 'Key' => 'key']
        );
    }
     ...
     * @return void
     */
    public function testAbortMultipartUploadIsCalledOnceOnFailure(): void
    {
        $this->addMockResults($this->client, [
            new Result(['ContentLength' => 10 * 1024 * 1024]),
            new Result(['UploadId'      => 'upload-id']),
